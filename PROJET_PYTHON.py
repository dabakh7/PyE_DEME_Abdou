...
def separe_note_function(notes):
    ...
    if valide == True:
        ...
        info = valide
    return matierNoteList, moyenne_general
...
with open("/home/abdou/PYTHON/Note_eleve.csv", 'r') as Note:
    ...
    for row in myReader:
        ...
        if (code!='' and nom!='' and prenom!='' and Date!='' and classe!='' and matiere!='' ) and \
                ...
                and (classe.endswith('A') or classe.endswith('B')) and transformdate(Date) != False and separe_note_function!= False:
                        moyenne11 ="moyenne",separe_note_function(matiere)[1]
                        comp11 = separe_note_function(matiere)[0]
